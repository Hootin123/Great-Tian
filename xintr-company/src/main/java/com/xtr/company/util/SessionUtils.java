...
public final class SessionUtils {
    ...
    private static final String SESSION_USER = "session_company_user";

    private static final String SESSION_VALIDATECODE = "session_company_validatecode";//验证码


    private static final String SESSION_ACCESS_URLS = "session_company_access_urls"; //系统能够访问的URL


    private static final String SESSION_MENUBTN_MAP = "session_company_menubtn_map"; //系统菜单按钮
     ...
     * @param user
     */
    public static void setUser(HttpServletRequest request, CompanyMembersBean user) {
     ...
     * @return SysUser
     */
    public static CompanyMembersBean getUser(HttpServletRequest request) {
     ...
     * @return SysUser
     */
    public static CompanysBean getCompany(HttpServletRequest request) {
        return getAttr(request, CommonConstants.LOGIN_COMPANY_KEY);
    }
