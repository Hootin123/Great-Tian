...
public class OffsetLimitInterceptor implements Interceptor{
	...
	public Object intercept(final Invocation invocation) throws Throwable {
        ...
        queryArgs[ROWBOUNDS_INDEX] = new org.apache.ibatis.session.RowBounds(RowBounds.NO_ROW_OFFSET,RowBounds.NO_ROW_LIMIT);
            ...
            Callable<Paginator> countTask = new Callable() {
                public Object call() throws Exception {
                    ...
                    if(cache != null && ms.isUseCache() && ms.getConfiguration().isCacheEnabled()){
                        CacheKey cacheKey = executor.createCacheKey(ms,parameter,new org.apache.ibatis.session.RowBounds(),copyFromBoundSql(ms,boundSql,dialect.getCountSQL(), boundSql.getParameterMappings(), boundSql.getParameterObject()));
