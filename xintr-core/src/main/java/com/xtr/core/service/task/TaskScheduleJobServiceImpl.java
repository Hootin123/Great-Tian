...
import com.xtr.core.persistence.reader.task.TaskScheduleJobReaderMapper;
import com.xtr.core.persistence.writer.task.TaskScheduleJobWriterMapper;
import org.quartz.*;
...
public class TaskScheduleJobServiceImpl implements TaskScheduleJobService {
    ...
    public ResultResponse selectPageList(TaskScheduleJobBean taskScheduleJobBean) {
        ...
        PageBounds pageBounds = new PageBounds(taskScheduleJobBean.getPageIndex(), taskScheduleJobBean.getPageSize());
     ...
     * 添加到数据库中 区别于addJob
     */
    @SystemServiceLog(operation = "新增任务", modelName = "任务管理")
...
//        }
     ...
     * @param jobId
     */
    @SystemServiceLog(operation = "删除任务", modelName = "任务管理")
     ...
     * @throws SchedulerException
     */
    @SystemServiceLog(operation = "修改任务", modelName = "任务管理")
     ...
     * @throws SchedulerException
     */
    @SystemServiceLog(operation = "启动任务", modelName = "任务管理")
...
//            pauseJob(job);
     ...
     * @throws SchedulerException
     */
    @SystemServiceLog(operation = "暂停任务", modelName = "任务管理")
     ...
     * @throws SchedulerException
     */
    @SystemServiceLog(operation = "恢复任务", modelName = "任务管理")
     ...
     * @throws SchedulerException
     */
    @SystemServiceLog(operation = "移除任务队列", modelName = "任务管理")
     ...
     * @throws SchedulerException
     */
    @SystemServiceLog(operation = "立即运行任务", modelName = "任务管理")
