...
//.............验证营业执照
    ...
    //                console.log(res);
    //                if (res.success) {
    //                    $("#upload").attr("src","http://xintairuan-img.oss-cn-hangzhou.aliyuncs.com/"+res.data);
    //                    $("[name=companyOrganizationImg]").val(res.data);
    //                    $(".hint").text("");
    //                    $(".hint").css("display","none");
    //                    fimg=true;
    //                } else {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        window.location.href = "toH5walletApproveWaitPage.htm?companyId="+companyId;
                    } else {
                        alert(data.message);
                    }
                }
...
//                fimg=true;
//                $.ajaxFileUpload({
//                    url: 'h5UploadOrganizeImg.htm?fileName='+fileName, //用于文件上传的服务器端请求地址
